		...
		if($update != null){
          ...
          $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
              ...
              'photo'=>"https://t.me/q5_u9",
                   'caption'=>'التفعيل بواسطة المطور علش†
~ @q5_u9 🍂',
...
لشراء نسخه مراسلة المطور 👁‍🗨',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'▫️| مطور البوت','url'=>'t.me/q5_u9']],
                       [['text'=>"▪️| قناه صيد المشتركين", 'url'=>"t.me/q5_u9"]],
                  ]
							])
					]);
				}
